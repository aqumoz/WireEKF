...
xpbd_pos = []   # list of (N, 3) arrays — node positions at each step
...
for k, t in enumerate(steps):
    ...
    pts = x_cur.reshape(N, 7)[:, :3]
    xpbd_pos.append(pts.copy())
    if k % 200 == 0:
...
print("  Saved results/xpbd_simulation.csv")
...
print("  Saved results/simulink_simulation.csv")
